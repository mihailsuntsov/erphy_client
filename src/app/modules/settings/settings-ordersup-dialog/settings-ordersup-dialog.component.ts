...
@Component({
  selector: 'app-settings-ordersup-dialog',
  templateUrl: './settings-ordersup-dialog.component.html',
  styleUrls: ['./settings-ordersup-dialog.component.css'],
  providers: [LoadSpravService,]
})
export class SettingsOrdersupDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,
    public SettingsDialog: MatDialogRef<SettingsOrdersupDialogComponent>,
  ...
  getSettings(){
    ...
    this.http.get('/api/auth/getSettingsOrdersup').subscribe
    (
      data => 
      { 
        result=data as any;
  ...
  getStatusesList(){
    ...
    this.loadSpravService.getStatusList(this.settingsForm.get('companyId').value,39) //39 - id документа из таблицы documents
      .subscribe(
          (data) => 
