...
@Component({
  selector: 'app-settings-paymentout-dialog',
  templateUrl: './settings-paymentout-dialog.component.html',
  styleUrls: ['./settings-paymentout-dialog.component.css'],
  providers: [LoadSpravService,]
})
export class SettingsPaymentoutDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,
    public SettingsDialog: MatDialogRef<SettingsPaymentoutDialogComponent>,
  ...
  getSettings(){
    ...
    this.http.get('/api/auth/getSettingsPaymentout').subscribe
    (
      data => 
      { 
        result=data as any;
  ...
  getStatusesList(){
    ...
    this.loadSpravService.getStatusList(this.settingsForm.get('companyId').value,34) //34 - id документа из таблицы documents
      .subscribe(
          (data) => 
