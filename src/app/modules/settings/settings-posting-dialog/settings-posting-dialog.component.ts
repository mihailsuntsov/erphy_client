...
@Component({
  selector: 'app-settings-posting-dialog',
  templateUrl: './settings-posting-dialog.component.html',
  styleUrls: ['./settings-posting-dialog.component.css'],
  providers: [LoadSpravService,]
})
export class SettingsPostingDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,
    public SettingsDialog: MatDialogRef<SettingsPostingDialogComponent>,
  ...
  getSettings(){
    ...
    this.http.get('/api/auth/getSettingsPosting').subscribe
    (
      data => 
      { 
        result=data as any;
  ...
  getStatusesList(){
    ...
    this.loadSpravService.getStatusList(this.settingsForm.get('companyId').value,16) //16 - id документа из таблицы documents
      .subscribe(
          (data) => 
