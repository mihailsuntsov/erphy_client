...
@Component({
  selector: 'app-file-categories-select',
  templateUrl: './file-categories-select.component.html',
  styleUrls: ['./file-categories-select.component.css'],
  providers: [LoadSpravService]
})
export class FileCategoriesSelectComponent implements OnInit {
  ...
  idTypes: string;  // что нужно выбрать - категории ( categories / files )
  ...
  constructor(
    public fileCategoriesSelectDialog: MatDialogRef<FileCategoriesSelectComponent>,
    private loadSpravService:   LoadSpravService,
    private _snackBar: MatSnackBar,
    public fileCategoriesDialog: MatDialog,
    public MessageDialog: MatDialog,
    public ConfirmDialog: MatDialog,
    public FileDuplicateDialog: MatDialog,
    ...
    ngOnInit() {
      ...
      this.idTypes = this.data.idTypes; // что выбираем - категории или товары (categories / files) Параметр передается из родительского компонента
...
// -------------------------------------- *** КОНЕЦ ПРАВ *** ------------------------------------
  ...
  onNoClick(): void {
    this.fileCategoriesSelectDialog.close();
  }
...
//*****************************************************************************************************************************************/
  ...
  loadTrees(){
    ...
    this.loadSpravService.getFileCategoriesTrees(this.companyId).subscribe(
      (data) => {
        this.treeDataSource.data=data as any [];
 ...
 recountNumRootCategories(){//считает количество корневых категорий
  ...
  //нажали "Выбрать"
  applySelect(){
    // this.fileCategoriesSelectDialog.close(this.selectedObjects);
