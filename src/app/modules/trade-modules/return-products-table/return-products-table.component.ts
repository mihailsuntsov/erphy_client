...
export class ReturnProductsTableComponent implements OnInit {
  ...
  @Input() parentDocName:string; // Идентификатор документа, в который вызывается данный компонент. Например, Return и т.д.
  ...
  ngOnInit(): void {
    ...
    this.formSearch = new UntypedFormGroup({
      ...
      product_netcost : new UntypedFormControl         ('',[Validators.required,Validators.pattern('^[0-9]{1,7}(?:[.,][0-9]{0,2})?\r?$')]),                      // себестоимость единицы товара
      ...
      product_sumnetcost : new UntypedFormControl      (0,[]),                       // суммарная себестоимость товара = себестоимость * кол-во
  ...
  formingProductRowFromApiResponse(row: ReturnProductTable) {
    return this._fb.group({
      ...
      // return_id:  new FormControl (+this.parentDocId,[]),
      ...
      product_netcost:  new UntypedFormControl (this.numToPrice(row.product_netcost,2),[Validators.required,Validators.pattern('^[0-9]{1,7}(?:[.,][0-9]{0,2})?\r?$')]),
  ...
  formingProductRowFromSearchForm() {
    return this._fb.group({
      ...
      product_netcost:  new UntypedFormControl (this.formSearch.get('product_netcost').value,[Validators.required,Validators.pattern('^[0-9]{1,7}(?:[.,][0-9]{0,2})?\r?$')]),
      ...
      product_sumnetcost: new UntypedFormControl ((+this.formSearch.get('product_count').value*(+this.formSearch.get('product_netcost').value)).toFixed(2),[]),
  ...
  formingProductRowFromProductsList(row: ProductSearchResponse) {
    return this._fb.group({
      ...
      product_netcost:  new UntypedFormControl (0,[Validators.required,Validators.pattern('^[0-9]{1,7}(?:[.,][0-9]{0,2})?\r?$')]),
      product_price:  new UntypedFormControl (0,[Validators.required,Validators.pattern('^[0-9]{1,7}(?:[.,][0-9]{0,2})?\r?$')]),
      product_sumprice: new UntypedFormControl (0,[]),
      product_sumnetcost: new UntypedFormControl (0,[]),
      nds_id: new UntypedFormControl (row.nds_id,[]),
      indivisible: new UntypedFormControl (row.indivisible,[]),
    });
  }
