...
interface dockResponse {//интерфейс для получения ответа в методе getDepartmentValuesById
    id: number;
    company_id: string;
    company: string;
    name: string;
...
@Component({
  selector: 'app-departments-dock',
  templateUrl: './departments-dock.component.html',
  styleUrls: ['./departments-dock.component.css'],
  providers: [LoadSpravService]
})
export class DepartmentsDockComponent implements OnInit {
...
        this.http.post('/api/auth/getDepartmentValuesById', dockId)
        .subscribe(
