...
        return this.http.post('/api/auth/getDepartmentsTable', body); 
    }
...
getPagesList(queryForm: QueryForm){
    ...
            return this.http.post('/api/auth/getDepartmentsPagesList', body); 
        }

getChildrens(parentId: number){
            const body = { parentId: parentId };
            return this.http.post('/api/auth/getDeptChildrens', body); 
        }
