...
isAllowToViewAllCompanies(e){return(e==122);}      //просмотр доков всех доступных предприятий
isAllowToViewMyCompany(e){return(e==123);}         //просмотр доков моего предприятия
...
isAllowToDelete   (e){return(e==121);}
isAllowToCreate   (e){return(e==120);}
...
// -------------------------------------- *** КОНЕЦ ПРАВ *** ------------------------------------
    ...
    getTableHeaderTitles(){
      ...
      this.displayedColumns.push('changer');
      this.displayedColumns.push('date_time_changed');
    }
    ...
    deleteDocks(){
      ...
      this.clearCheckboxSelection();
        return this.http.post('/api/auth/deleteSpravSysEdizm', body) 
              .subscribe(
                  (data) => {   
                              this.receivedMatTable=data as any []; 
                              this.dataSource.data = this.receivedMatTable;
