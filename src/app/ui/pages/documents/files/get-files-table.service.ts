...
        const body = {  searchString: queryForm.searchString, 
                        ...
                        any_boolean:queryForm.trash,
                        any_boolean2:queryForm.showOnlyAnonymeAccessFiles,
                      };
                        
        return this.http.post('/api/auth/getFilesTable', body); 
    }
...
getPagesList(queryForm: QueryForm){
    ...
            return this.http.post('/api/auth/getFilesPagesList', body); 
        }
