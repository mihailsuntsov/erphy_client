...
export class InvoiceoutDocComponent implements OnInit {
  ...
  constructor(private activateRoute: ActivatedRoute,
    ...
    private _fb: FormBuilder, //чтобы билдить группу форм invoiceoutProductTable
  ...
  ngOnInit() {
    this.formBaseInformation = new FormGroup({
      ...
      invoiceout_date: new FormControl      ('',[Validators.required]),
      ...
      uid: new FormControl                ('',[]),// uuid идентификатор для создаваемого документа
    });
