...
export class PostingDocComponent implements OnInit {
  ...
  constructor(private activateRoute: ActivatedRoute,
    ...
    private _fb: UntypedFormBuilder, //чтобы билдить группу форм postingProductTable
...
//-------------------------------------------------------------------------------
  ...
  getCRUD_rights(){
    this.allowToCreateAllCompanies = this.permissionsSet.some(         function(e){return(e==200)});
    this.allowToCreateMyCompany = this.permissionsSet.some(            function(e){return(e==201)});
    this.allowToCreateMyDepartments = this.permissionsSet.some(        function(e){return(e==202)});
    this.allowToViewAllCompanies = this.permissionsSet.some(           function(e){return(e==207)});
    this.allowToViewMyCompany = this.permissionsSet.some(              function(e){return(e==208)});
    this.allowToViewMyDepartments = this.permissionsSet.some(          function(e){return(e==209)});
    this.allowToViewMyDocs = this.permissionsSet.some(                 function(e){return(e==210)});
    this.allowToUpdateAllCompanies = this.permissionsSet.some(         function(e){return(e==211)});
    this.allowToUpdateMyCompany = this.permissionsSet.some(            function(e){return(e==212)});
    this.allowToUpdateMyDepartments = this.permissionsSet.some(        function(e){return(e==213)});
    this.allowToUpdateMyDocs = this.permissionsSet.some(               function(e){return(e==214)});
    this.allowToCompleteAllCompanies = this.permissionsSet.some(       function(e){return(e==627)});
    this.allowToCompleteMyCompany = this.permissionsSet.some(          function(e){return(e==628)});
    this.allowToCompleteMyDepartments = this.permissionsSet.some(      function(e){return(e==629)});
    this.allowToCompleteMyDocs = this.permissionsSet.some(             function(e){return(e==630)});
...
    this.http.get('/api/auth/getPostingValuesById?id='+ this.id)
  ...
  formingProductRowFromApiResponse(row: PostingProductTable) {
    return this._fb.group({
      ...
      posting_id:      new UntypedFormControl (this.id,[]),
      ...
      (data) => {
                  ...
                  switch(this.createdDocId){
                    case null:{// null возвращает если не удалось создать документ из-за ошибки
                      this.MessageDialog.open(MessageDialog,{width:'400px',data:{head:translate('docs.msg.error'),message:translate('docs.msg.crte_doc_err',{name:translate('docs.docs.posting')})}});
                      break;
                    }
      ...
      .subscribe(
          ...
          {   
            ...
            switch(result){
              ...
              case 1:{// Успешно
                this.openSnackBar(translate('docs.msg.cnc_com_succs',{name:translate('docs.docs.posting')}), translate('docs.msg.close'));
      ...
      .subscribe(
          ...
          {   
            ...
            switch(result){
              ...
              default:{// Успешно
                this.openSnackBar(translate('docs.msg.doc_name',{name:translate('docs.docs.posting')}) + (complete?translate('docs.msg.completed'):translate('docs.msg.saved')), translate('docs.msg.close'));
                ...
                if(complete) {
                  ...
                  if(this.settingsForm.get('statusOnFinishId').value&&this.statusIdInList(this.settingsForm.get('statusOnFinishId').value)){// если в настройках есть "Статус при проведении" и он от этого предприятия - выставляем его
                    this.formBaseInformation.get('status_id').setValue(this.settingsForm.get('statusOnFinishId').value);}
  ...
  getProductsTable(){
    const control = <UntypedFormArray>this.formBaseInformation.get('postingProductTable');
    control.clear();
...
//       this.formReturnsup.get('description').setValue(translate('docs.msg.created_from')+translate('docs.docs.posting')+' '+translate('docs.top.number')+this.formBaseInformation.get('doc_number').value);
