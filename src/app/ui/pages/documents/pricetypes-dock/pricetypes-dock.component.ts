...
@Component({
  selector: 'app-pricetypes-dock',
  templateUrl: './pricetypes-dock.component.html',
  styleUrls: ['./pricetypes-dock.component.css'],
  providers: [LoadSpravService,]

})
export class PricetypesDockComponent implements OnInit {
...
// -------------------------------------- *** ПРАВА *** ------------------------------------
  getSetOfPermissions(){
    const body = {"documentId": 9};//9=Типы цен
  ...
          this.http.post('/api/auth/getTypePricesValuesById', dockId)
        .subscribe(
