...
documentsIds: idAndName [] = [{id:"15", name:"Приёмка"},{id:"21", name:"Отгрузка"},{id:"16", name:"Оприходование"},{id:"17", name:"Списание"}]//список документов, по которым можно получить отчёт
