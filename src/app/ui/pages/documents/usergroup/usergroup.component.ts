...
import { QueryFormService } from './get-usergroup-table.service';
...
isAllowToUpdateMy (e){return(e==33);}//все моего предприятия
isAllowToUpdateAll(e){return(e==34);}//всех доступных предприятий
//isAllowToViewMy   (e){return(e==5);}
//isAllowToViewAll  (e){return(e==6);}

getTableHeaderTitles(){
  if(this.allowToDelete) this.displayedColumns.push('select');
  if(this.allowToUpdateMy||this.allowToUpdateAll) this.displayedColumns.push('opendoc');
