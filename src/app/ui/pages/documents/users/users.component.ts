...
export class UsersComponent implements OnInit {
  ...
  constructor(private queryFormService:   QueryFormService,
    ...
    ngOnInit() {
      ...
      if(Cookie.get('users_companyId')=='undefined' || Cookie.get('users_companyId')==null)     
        Cookie.set('users_companyId',this.sendingQueryForm.companyId); else this.sendingQueryForm.companyId=(Cookie.get('users_companyId')=="0"?"0":+Cookie.get('users_companyId'));
      if(Cookie.get('users_sortAsc')=='undefined' || Cookie.get('users_sortAsc')==null)       
        Cookie.set('users_sortAsc',this.sendingQueryForm.sortAsc); else this.sendingQueryForm.sortAsc=Cookie.get('users_sortAsc');
      if(Cookie.get('users_sortColumn')=='undefined' || Cookie.get('users_sortColumn')==null)    
        Cookie.set('users_sortColumn',this.sendingQueryForm.sortColumn); else this.sendingQueryForm.sortColumn=Cookie.get('users_sortColumn');
      if(Cookie.get('users_offset')=='undefined' || Cookie.get('users_offset')==null)        
        Cookie.set('users_offset',this.sendingQueryForm.offset); else this.sendingQueryForm.offset=Cookie.get('users_offset');
  ...
  getCRUD_rights(){
    ...
    this.allowToDeleteAllCompanies = this.permissionsSet.some(         function(e){return(e==23)});
    this.allowToDeleteMyCompany = this.permissionsSet.some(            function(e){return(e==23)});
...
// -------------------------------------- *** КОНЕЦ ПРАВ *** ------------------------------------
  ...
  setNumOfPages(){
    ...
    this.createCheckedList();
    this.sendingQueryForm.offset=0;
    Cookie.set('users_result',this.sendingQueryForm.result);
    this.getData();
  }
  ...
  setSort(valueSortColumn:any) // set sorting column
  {
      ...
      Cookie.set('users_sortAsc',this.sendingQueryForm.sortAsc);
      } else {
          this.sendingQueryForm.sortColumn=valueSortColumn;
          this.sendingQueryForm.sortAsc="asc";
          Cookie.set('users_sortAsc',"asc");
          Cookie.set('users_sortColumn',valueSortColumn);
      }
      this.getData();
  }
  onCompanySelection(){
