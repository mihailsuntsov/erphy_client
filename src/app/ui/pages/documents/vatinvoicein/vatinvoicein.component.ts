...
// -------------------------------------- *** КОНЕЦ ПРАВ *** ------------------------------------
  ...
  setDefaultCompany(){
    if(Cookie.get('vatinvoicein_companyId')=='0'){
  ...
  onClickCreateBtn(){
    this.MessageDialog.open(MessageDialog,{width:'400px',data:{head:'Внимание!',message:'"Счёт-фактура полученный" можно создать только из следующих документов: "Расходный ордер", "Исходящий платёж", "Приёмка"'}})
  }
      //*************************************************************   НАСТРОЙКИ   ************************************************************/    
